            ...
            <article class="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
                <footer class="flex justify-between items-center mb-4">
                    <div class="flex items-center gap-4">
                        <img class="h-12 w-12 rounded-full" src="{{ asset('avatar/default.svg') }}" alt="Michael Gough">
                ...
                <div>
                    <p class="text-gray-500 text-lg mb-1">Ulasan untuk <span
                            class="text-gray-700 font-semibold">Perpustakaan</span></p>
