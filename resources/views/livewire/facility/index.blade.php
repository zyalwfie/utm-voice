<section class="mt-28 mb-8 max-w-screen-xl p-4 mx-auto flex flex-col lg:flex-row gap-x-8 gap-y-10">
    ...
    <div class="lg:w-8/12">
        <form class="flex gap-2 justify-end items-center mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach ($this->facilities as $facility)
                <div
                    ...
                    <div class="pt-6">
                        <a href="{{ route('landing.facility.show', $facility->slug) }}"
                            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ $facility->name }}</a>
                        <div class="mt-2 flex items-center gap-2">
                            ...
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">({{ count($facility->comments) }})</p>
                        </div>
