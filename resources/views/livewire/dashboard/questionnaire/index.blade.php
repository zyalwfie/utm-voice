    ...
    <div class="mb-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Analisis kepuasan dan kualitas fasilitas berdasarkan rating pengguna</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="mb-1 text-sm font-medium text-gray-500 dark:text-gray-400">Total Responden</p>
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $this->overviewStats['totalResponden'] }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div class="flex items-center">
                            <div class="mr-4 inline-flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-{{ $this->overviewStats['overallRatingColor'] }}-100 dark:bg-{{ $this->overviewStats['overallRatingColor'] }}-900">
                                <svg class="h-6 w-6 text-{{ $this->overviewStats['overallRatingColor'] }}-600 dark:text-{{ $this->overviewStats['overallRatingColor'] }}-300" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                            </div>
                            <div>
                                <p class="mb-1 text-sm font-medium text-gray-500 dark:text-gray-400">Rata-rata Rating</p>
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $this->overviewStats['overallAvgRating'] }}/5.0</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div class="flex items-center">
                            <div class="mr-4 inline-flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-{{ $this->overviewStats['overallRatingColor'] }}-100 dark:bg-{{ $this->overviewStats['overallRatingColor'] }}-900">
                                ...
                                @else
                                    <svg class="h-6 w-6 text-{{ $this->overviewStats['overallRatingColor'] }}-600 dark:text-{{ $this->overviewStats['overallRatingColor'] }}-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl font-bold text-{{ $this->overviewStats['overallRatingColor'] }}-600 dark:text-{{ $this->overviewStats['overallRatingColor'] }}-400">{{ $this->overviewStats['overallRatingLabel'] }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div class="mb-4 flex items-center justify-between">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Rating Kepuasan per Fasilitas</h3>
                        </div>
                        <div class="h-80">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Perbandingan Kualitas Fasilitas</h3>
                    </div>
                    <div class="space-y-4">
                        @foreach ($this->facilitiesWithStats as $facility)
                            <div class="flex items-center gap-4">
                                <div class="w-32 flex-shrink-0 truncate text-sm font-medium text-gray-700 dark:text-gray-300">
                                    {{ $facility->name }}
                                </div>
                                <div class="flex-1">
                                    <div class="h-4 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                                        <div class="h-4 rounded-full bg-{{ $facility->rating_color }}-500" style="width: {{ ($facility->avg_rating / 5) * 100 }}%"></div>
                                    </div>
                                </div>
                                <div class="w-20 flex-shrink-0 text-right">
                                    <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $facility->avg_rating }}/5.0</span>
                                </div>
                                <div class="w-28 flex-shrink-0">
                                    <span class="inline-flex items-center rounded-full bg-{{ $facility->rating_color }}-100 px-2.5 py-0.5 text-xs font-medium text-{{ $facility->rating_color }}-800 dark:bg-{{ $facility->rating_color }}-900 dark:text-{{ $facility->rating_color }}-300">
                ...
                @forelse ($this->facilitiesWithStats as $facility)
                    <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="flex flex-col gap-4 border-b border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex items-center gap-4">
                                <div class="inline-flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-lg bg-{{ $facility->rating_color }}-100 dark:bg-{{ $facility->rating_color }}-900">
                                    <span class="text-xl font-bold text-{{ $facility->rating_color }}-600 dark:text-{{ $facility->rating_color }}-300">{{ $facility->avg_rating }}</span>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-1 flex flex-wrap items-center gap-3">
                                        ...
                                        <span class="text-sm text-gray-500 dark:text-gray-400">
                                            {{ $facility->questions_count }} kuesioner • {{ $facility->total_answers }} responden
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Facility Summary -->
                        <div class="border-t border-gray-200 bg-{{ $facility->rating_color }}-50 p-4 dark:border-gray-700 dark:bg-{{ $facility->rating_color }}-900/20">
                            <p class="text-sm text-{{ $facility->rating_color }}-800 dark:text-{{ $facility->rating_color }}-300">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black/50">
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white p-4 text-center shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah Anda yakin ingin menghapus kuesioner ini?</p>
                                ...
                                <div class="rounded-lg border border-gray-200 p-4 dark:border-gray-600">
                                    <div class="flex items-start justify-between">
                                        <div class="flex items-center space-x-3">
                                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-{{ $ratingColor }}-100 dark:bg-{{ $ratingColor }}-900">
                                                <span class="text-lg font-bold text-{{ $ratingColor }}-600 dark:text-{{ $ratingColor }}-300">
                                                    {{ $rating ?? '?' }}
                                                </span>
                                            </div>
                                            <div>
                                        ...
                                        <span class="inline-flex items-center rounded-full bg-{{ $ratingColor }}-100 px-2.5 py-0.5 text-xs font-medium text-{{ $ratingColor }}-800 dark:bg-{{ $ratingColor }}-900 dark:text-{{ $ratingColor }}-300">
                                            {{ $answer->content }}
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <div class="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
                            ...
                            <div class="rounded-lg bg-purple-50 p-4 dark:bg-purple-900/20">
                                <p class="text-sm text-purple-600 dark:text-purple-400">Total Responden</p>
                                <p class="text-2xl font-bold text-purple-700 dark:text-purple-300">{{ $this->selectedFacilityData['totalResponden'] }}</p>
                            </div>
                            <div class="rounded-lg bg-{{ $this->selectedFacilityData['ratingColor'] }}-50 p-4 dark:bg-{{ $this->selectedFacilityData['ratingColor'] }}-900/20">
                                <p class="text-sm text-{{ $this->selectedFacilityData['ratingColor'] }}-600 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-400">Rata-rata Rating</p>
                                <p class="text-2xl font-bold text-{{ $this->selectedFacilityData['ratingColor'] }}-700 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-300">{{ $this->selectedFacilityData['avgRating'] }}/5.0</p>
                            </div>
                            <div class="rounded-lg bg-{{ $this->selectedFacilityData['ratingColor'] }}-50 p-4 dark:bg-{{ $this->selectedFacilityData['ratingColor'] }}-900/20">
                                <p class="text-sm text-{{ $this->selectedFacilityData['ratingColor'] }}-600 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-400">Status</p>
                                <p class="text-xl font-bold text-{{ $this->selectedFacilityData['ratingColor'] }}-700 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-300">{{ $this->selectedFacilityData['ratingLabel'] }}</p>
                            </div>
                        </div>

                        <!-- Summary -->
                        <div class="mb-6 rounded-lg bg-{{ $this->selectedFacilityData['ratingColor'] }}-50 p-4 dark:bg-{{ $this->selectedFacilityData['ratingColor'] }}-900/20">
                            <h4 class="mb-2 font-semibold text-{{ $this->selectedFacilityData['ratingColor'] }}-800 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-300">Kesimpulan</h4>
                            <p class="text-{{ $this->selectedFacilityData['ratingColor'] }}-700 dark:text-{{ $this->selectedFacilityData['ratingColor'] }}-400">
                                    ...
                                    <div class="mb-2 flex items-start justify-between">
                                        ...
                                        <div class="ml-2 flex items-center gap-2">
                                            ...
                                            @if($question->avg_rating > 0)
                                                <span class="inline-flex items-center rounded-full bg-{{ $question->rating_info['color'] }}-100 px-2 py-1 text-xs font-medium text-{{ $question->rating_info['color'] }}-800 dark:bg-{{ $question->rating_info['color'] }}-900 dark:text-{{ $question->rating_info['color'] }}-300">
