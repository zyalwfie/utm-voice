<main class="p-4 md:ml-64 h-auto pt-20">
        ...
        <div class="bg-white dark:bg-gray-800 relative border border-gray-300 sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <button type="button" wire:click="toggleOpenModal"
    ...
    <!-- Main modal -->
    <div id="createModal" tabindex="-1" aria-hidden="true" wire:show="showCreateModal"
        class="flex antialiased overflow-y-auto overflow-x-hidden bg-gray-800/50 fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0">
                    ...
                    <div class="flex flex-col gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select id="facility" wire:model='facilityId'
                                ...
                                <option selected>Untuk fasilitas</option>
                        ...
                        <div>
                            ...
                            <textarea id="question" rows="4" wire:model='question'
                                ...
                                placeholder="Tulis kuesioner fasilitas di sini"></textarea>
                        </div>
                    </div>
