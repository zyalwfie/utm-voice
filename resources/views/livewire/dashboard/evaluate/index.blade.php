<main class="p-4 md:ml-64 h-auto pt-20">
                        ...
                        <div id="filterDropdown"
                            ...
                            <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                <li class="flex items-center">
                                    <input id="sort-facility" type="radio" wire:model.live="sortKey" value="facility"
                                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    <label for="sort-facility"
                                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Nama Fasilitas</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="sort-answers" type="radio" wire:model.live="sortKey" value="answers_count"
                                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                    <label for="sort-answers"
                                        class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Jumlah Jawaban</label>
                                </li>
                                <li class="flex items-center">
                                    <input id="sort-newest" type="radio" wire:model.live="sortKey" value="created_at"
                                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Jumlah Jawaban</th>
                        ...
                        @forelse ($this->questions as $question)
                            <tr class="border-t border-gray-300">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($question->answers_count > 0)
                                            <button type="button"
                                                wire:click="openAnswersModal({{ $question->id }})"
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="{{ $question->id }}-dropdown-button"
                                        data-dropdown-toggle="{{ $question->id }}-dropdown"
                                    ...
                                    <div id="{{ $question->id }}-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="{{ $question->id }}-dropdown-button">
                                            @if($question->answers_count > 0)
                                                <li>
                                                    <button type="button" wire:click="openAnswersModal({{ $question->id }})"
                                            ...
                                            @endif
                                            <li>
                                                <button type="button" wire:click="openUpdateModal({{ $question->id }})"
                                                    class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                            ...
                                            <li>
                                                <button type="button" wire:click="openDeleteModal({{ $question->id }})"
                ...
                <form class="p-4 md:p-5">
                    <div class="flex flex-col gap-4 mb-4">
                        <div>
                            ...
                            @error('facilityId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="question"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kuesioner</label>
                    ...
                    <button type="button" wire:click='createNewQuestion'
                        ...
                        Tambahkan kuesioner baru
                        <svg wire:loading wire:target='createNewQuestion' aria-hidden="true" role="status"
                            class="inline w-4 h-4 ml-2 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101"
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5">
                    ...
                    <button type="button" wire:click='updateQuestion'
                        class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <svg class="me-1 -ms-1 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                        </svg>
                        Perbarui kuesioner
                        <svg wire:loading wire:target='updateQuestion' aria-hidden="true" role="status"
                            class="inline w-4 h-4 ml-2 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
    ...
    <div id="deleteModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <p class="mb-4 text-gray-500 dark:text-gray-300">Apakah Anda yakin ingin menghapus kuesioner ini? Semua jawaban akan ikut terhapus.
                </p>
    ...
    <!-- Answers Modal -->
    <div id="answersModal" tabindex="-1" aria-hidden="true"
        @if ($showAnswersModal) style="display: flex !important; background-color: rgba(0,0,0,0.5);" @else style="display: none !important;" @endif
        class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full">
                    ...
                    @if($selectedQuestionId)
                        ...
                        @if($selectedQuestion)
                            <div class="mb-4 p-4 bg-gray-50 rounded-lg dark:bg-gray-700">
                                <h4 class="font-medium text-gray-900 dark:text-white mb-2">Pertanyaan:</h4>
