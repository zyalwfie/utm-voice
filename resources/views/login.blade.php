            ...
            <div
                ...
                <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
                    ...
                    <form class="flex flex-col gap-4" action="{{ route('login') }}" method="POST">
                        ...
                        <div>
                            <label for="email"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Email atau
                                NIM</label>
                            <input type="text" name="email" id="email" value="{{ old('email') }}"
                                ...
                                placeholder="Masukkan email atau NIM Anda" required autofocus>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="password" id="password"
                                        ...
                                        class="focus:ring-primary-600 focus:border-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pr-10 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                        required>
